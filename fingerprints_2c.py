...
#     vessel_img = cv2.imread("dataset/onDrive/IM000001_1_seg.png", cv2.IMREAD_GRAYSCALE)
...
if __name__ == "__main__":
    ...
    vessel_gray = cv2.imread("dataset/onDrive/IM000001_1_seg.png", cv2.IMREAD_GRAYSCALE)
